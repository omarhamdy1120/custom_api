...
curl_setopt($curl_handle, CURLOPT_URL,"http://localhost/task/auth.php?"+token);
...
<script>
const token='0800fc577294c34e0b28ad2839435945';
fetch("http://localhost/task/auth.php?"+token,{mode:'no-cors',headers: {'Accept': 'application/json'}})
